  ...
  return (
    <div data-color="white" className="para section w-full flex items-center justify-center px-8  ">
        <div className="text sm:w-[80%] flex flex-col items-center sm:items-start justify-between ">
            ...
            <h3 className='textpara sm:w-[50%] text-blue-600 font-[Sansita] tracking-wide text-[2.4vh] sm:text-[3.5vh] font-medium text-center leading-[5vh] mb-10'>Another year older, another year wiser! Birthdays are a time for reflection, celebration, and looking forward to the future. It's a day to appreciate the journey and the people who make it special.</h3>
            <div className="pers w-[50%] flex flex-col items-center justify-center gap-2 ">
                ...
                <h1 className=' text-[2.8vh] sm:text-[3.8vh] font-medium'>Birthday Philosopher</h1>
                <h3 className='text-zinc-500 text-[2.4vh] whitespace-nowrap'>Spreading Birthday Cheer</h3>
            </div>
        </div>  
    </div>
  )
